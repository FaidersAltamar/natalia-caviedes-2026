        ...
        <section className="py-40 bg-gradient-to-br from-green-600 via-green-600 to-green-700 relative overflow-hidden">
            ...
            <div className="max-w-5xl mx-auto px-6 relative z-10 text-center">
                ...
                <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
                    <a href="https://wa.me/573000000000" target="_blank" className="group relative bg-white text-green-700 px-12 py-6 rounded-full font-bold text-sm md:text-base flex items-center gap-4 hover:scale-110 hover:shadow-2xl transition-all duration-300 shadow-xl shadow-green-900/40 w-full sm:w-auto justify-center overflow-hidden">
