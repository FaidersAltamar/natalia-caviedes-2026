      ...
      <div className="max-w-7xl mx-auto px-8 relative z-10">
        <div className="grid lg:grid-cols-12 gap-24 items-center">
          <div className="lg:col-span-5 relative">
            <div className="absolute -inset-6 bg-green-600 rounded-[4rem] rotate-3 opacity-10"></div>
            <div className="relative z-10 rounded-[3.5rem] overflow-hidden border-8 border-white shadow-2xl bg-slate-50 flex items-end aspect-[4/5]">
              <img 
                src={CANDIDATE_PHOTO} 
                alt="Natalia Perfil" 
            ...
            <div className="absolute -top-10 -right-10 bg-slate-900 text-white p-10 rounded-full shadow-2xl z-20 flex flex-col items-center justify-center w-40 h-40 border-8 border-white">
              <Heart className="mb-2 text-green-500" size={32} fill="currentColor" />
              <p className="text-[10px] font-black uppercase text-center leading-none tracking-widest">AMOR POR EL HUILA</p>
            </div>
          </div>
          ...
          <div className="lg:col-span-7 space-y-12">
            <div className="space-y-4">
              <div className="flex items-center space-x-4 text-green-600">
                ...
                <span className="text-[11px] font-black uppercase tracking-[0.5em]">LIDERAZGO FEMENINO</span>
              </div>
              <img src={NAME_LOGO} className="h-24 w-auto object-contain filter grayscale brightness-0 opacity-90" alt="Natalia Caviedes" />
              <h3 className="text-3xl font-display font-black text-green-600 tracking-tighter uppercase italic -mt-6">Huilense de Corazón.</h3>
            </div>
               ...
               <div className="space-y-6">
                 ...
                 <div className="flex flex-wrap gap-3">
                    {PROFILE_INFO.roles.map((role, i) => (
                      <span key={i} className="px-5 py-2 rounded-full bg-green-100 text-green-700 text-[10px] font-black uppercase tracking-widest border border-green-200">
                        {role}
                      </span>
                    ))}
                 </div>
               </div>
               <div className="bg-green-600 p-12 rounded-[3.5rem] text-white shadow-2xl shadow-green-600/30 relative overflow-hidden group">
                  <div className="absolute top-0 right-0 w-32 h-32 bg-white/10 blur-3xl rounded-full"></div>
                  <Quote className="text-white/20 mb-6" size={48} />
                  <p className="text-2xl font-medium italic leading-tight group-hover:scale-105 transition-transform">
